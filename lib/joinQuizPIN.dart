...
class JoinQuizPIN extends StatefulWidget {
  const JoinQuizPIN({super.key});

  @override
  _JoinQuizPINState createState() => _JoinQuizPINState();
}
...
class _JoinQuizPINState extends State<JoinQuizPIN> {
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        QuerySnapshot<Map<String, dynamic>> query3;
                        query3 = await FirebaseFirestore.instance
                            .collection('group')
                            .where("pin", isEqualTo: currentText)
                            .get();
                        ...
                        if (query3.docs.isNotEmpty) {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const RecentlyQuiz()));
                        }
